! function(t, e, r, n, o) {
    ...
    fNNyd: [function(t, e, r) {
        ...
        let g = `©${(new Date).getFullYear()} clovic.xyz`;
        ...
        (0, n.inlinesvg)(".inlineSvgFile", (t => {
            ...
            const r = () => {
                3 === e.length + 1 && setTimeout((() => {
                    ...
                    t.parentNode.removeChild(t), document.querySelector('a[aria-label="github"]').setAttribute("href", "https://github.com/clovicdev/"), document.querySelector('a[aria-label="email"]').setAttribute("href", "mailto:business.clovic@gmail.com?subject=Mail from clovic.xyz")
                }), 50)
            };
